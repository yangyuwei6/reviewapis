...
const (
	...
	ErrorReason_Review_NOT_FOUND                ErrorReason = 3
	ErrorReason_Review_ALREADY_REPLIED          ErrorReason = 4
	ErrorReason_HORIZONTAL_PRIVILEGE_ESCALATION ErrorReason = 5
)
...
var (
	ErrorReason_name = map[int32]string{
		...
		2: "ORDER_REVIEWED",
		3: "Review_NOT_FOUND",
		4: "Review_ALREADY_REPLIED",
		5: "HORIZONTAL_PRIVILEGE_ESCALATION",
	}
	ErrorReason_value = map[string]int32{
		...
		"ORDER_REVIEWED":                  2,
		"Review_NOT_FOUND":                3,
		"Review_ALREADY_REPLIED":          4,
		"HORIZONTAL_PRIVILEGE_ESCALATION": 5,
	}
)
...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.review.v1\x1a\x1fthird_party/errors/errors.proto*\xc1\x01\n" +
	"\vErrorReason\x12\x14\n" +
	"\n" +
	"NEED_LOGIN\x10\x00\x1a\x04\xa8E\x91\x03\x12\x13\n" +
	"\tDB_FAILED\x10\x01\x1a\x04\xa8E\xf4\x03\x12\x18\n" +
	"\x0eORDER_REVIEWED\x10\x02\x1a\x04\xa8E\x95\x03\x12\x1a\n" +
	"\x10Review_NOT_FOUND\x10\x03\x1a\x04\xa8E\x94\x03\x12 \n" +
	"\x16Review_ALREADY_REPLIED\x10\x04\x1a\x04\xa8E\x96\x03\x12)\n" +
	"\x1fHORIZONTAL_PRIVILEGE_ESCALATION\x10\x05\x1a\x04\xa8E\x97\x03\x1a\x04\xa0E\xf4\x03B2\n" +
