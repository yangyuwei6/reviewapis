...
const (
	...
	Review_GetReviewByReviewID_FullMethodName = "/api.review.v1.Review/GetReviewByReviewID"
...
type ReviewClient interface {
	...
	GetReviewByReviewID(ctx context.Context, in *GetReviewRequest, opts ...grpc.CallOption) (*GetReviewReply, error)
	// O端审核评价
...
func (c *reviewClient) GetReviewByReviewID(ctx context.Context, in *GetReviewRequest, opts ...grpc.CallOption) (*GetReviewReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetReviewReply)
	err := c.cc.Invoke(ctx, Review_GetReviewByReviewID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) GetReviewByReviewID(context.Context, *GetReviewRequest) (*GetReviewReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReviewByReviewID not implemented")
}
...
func _Review_GetReviewByReviewID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetReviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).GetReviewByReviewID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_GetReviewByReviewID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).GetReviewByReviewID(ctx, req.(*GetReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetReviewByReviewID",
			Handler:    _Review_GetReviewByReviewID_Handler,
		},
		{
